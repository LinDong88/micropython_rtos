...
QDEF1(MP_QSTR_IRQ_RISING_FALLING, 54624, 18, "IRQ_RISING_FALLING")
...
QDEF1(MP_QSTR_current_tid, 10442, 11, "current_tid")
...
QDEF1(MP_QSTR_is_preempt_thread, 35610, 17, "is_preempt_thread")
QDEF1(MP_QSTR_isenabled, 58778, 9, "isenabled")
QDEF1(MP_QSTR_iterator, 48711, 8, "iterator")
QDEF1(MP_QSTR_list_device, 38432, 11, "list_device")
...
QDEF1(MP_QSTR_rtthread, 55405, 8, "rtthread")
QDEF1(MP_QSTR_sleep, 10218, 5, "sleep")
QDEF1(MP_QSTR_soft_reset, 26081, 10, "soft_reset")
QDEF1(MP_QSTR_stacks_analyze, 22371, 14, "stacks_analyze")
